...
Use this page to compare the main specifications of `HL-3604-C001` and plan power, control and mechanical integration.
...
| --- | --- |
| Input voltage | **6 V** |
| Stall torque | **4 kg·cm@6V** |
| Control interface | `TTL` |
| Product family | `HLS` |
| Product model | `HL-3604-C001` |
