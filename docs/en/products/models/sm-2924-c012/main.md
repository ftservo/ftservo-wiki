...
Use this page to compare the main specifications of `SM-2924-C012` and plan power, control and mechanical integration.
...
| Stall torque | **20 kg·cm@24V** |
| Control interface | `RS-485` |
| Product family | `SMS` |
| Product model | `SM2924-C012` |
| Document revision | `A/2` |
