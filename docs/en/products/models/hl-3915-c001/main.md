...
Use this page to compare the main specifications of `HL-3915-C001` and plan power, control and mechanical integration.
...
| Stall torque | **14 kg·cm@12V** |
| Control interface | `TTL` |
| Product family | `HLS` |
| Product model | `HLS3915M-C001` |
