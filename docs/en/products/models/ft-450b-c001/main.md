...
Use this page to compare the main specifications of `FT-450B-C001` and plan power, control and mechanical integration.
...
| Stall torque | **450 kg·cm@24V** |
| Control interface | `PWM` |
| Product family | `FT` |
| Product model | `FT450BL` |
