...
Use this page to compare the main specifications of `ST-3009-C001` and plan power, control and mechanical integration.
...
| --- | --- |
| Input voltage | **6 V** |
| Stall torque | **9 kg·cm@6V** |
| Control interface | `TTL` |
| Product family | `STS` |
| Product model | `STS3009BL-C001` |
