...
Use this page to compare the main specifications of `HL-3620-C001` and plan power, control and mechanical integration.
...
| --- | --- |
| Input voltage | **7.4 V** |
| Stall torque | **20 kg·cm@7.4V** |
| Control interface | `TTL` |
| Product family | `HLS` |
| Product model | `HLS3620M-C001` |
