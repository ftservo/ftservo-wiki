...
Use this page to compare the main specifications of `SM-105B-C001` and plan power, control and mechanical integration.
...
| Stall torque | **150 kg·cm@12V** |
| Control interface | `RS-485` |
| Product family | `SMS` |
| Product model | `SM105BL-C001` |
