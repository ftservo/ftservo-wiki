...
Use this page to compare the main specifications of `SM-160B-C001` and plan power, control and mechanical integration.
...
| Stall torque | **160 kg·cm@24V** |
| Control interface | `RS-485` |
| Product family | `SMS` |
| Product model | `SM160BL-C001` |
