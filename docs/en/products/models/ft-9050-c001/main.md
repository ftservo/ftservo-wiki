...
Use this page to compare the main specifications of `FT-9050-C001` and plan power, control and mechanical integration.
...
| --- | --- |
| Input voltage | **7.4 V** |
| Stall torque | **50 kg·cm@7.4V** |
| Control interface | `PWM` |
| Product family | `FT` |
| Product model | `FT9050M-C001` |
