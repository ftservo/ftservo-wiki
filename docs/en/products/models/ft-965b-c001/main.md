...
Use this page to compare the main specifications of `FT-965B-C001` and plan power, control and mechanical integration.
...
| --- | --- |
| Input voltage | **8.4 V** |
| Stall torque | **60 kg·cm@8.4V** |
| Control interface | `PWM` |
| Product family | `FT` |
| Product model | `FT965BL-C001` |
