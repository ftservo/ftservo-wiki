...
Use this page to compare the main specifications of `ST-3200-C001` and plan power, control and mechanical integration.
...
| Stall torque | **200 kg·cm@12V** |
| Control interface | `TTL` |
| Product family | `STS` |
| Product model | `ST-3200-C001` |
