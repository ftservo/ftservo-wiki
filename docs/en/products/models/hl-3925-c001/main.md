...
Use this page to compare the main specifications of `HL-3925-C001` and plan power, control and mechanical integration.
...
| Stall torque | **25 kg·cm@12V** |
| Control interface | `TTL` |
| Product family | `HLS` |
| Product model | `HLS3925M-C001` |
