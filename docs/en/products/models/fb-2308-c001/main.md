...
Use this page to compare the main specifications of `FB-2308-C001` and plan power, control and mechanical integration.
...
| Stall torque | **7 kg·cm@12V** |
| Control interface | `PWM` |
| Product family | `FB` |
| Product model | `FB2308M` |
