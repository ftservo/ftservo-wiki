...
Use this page to compare the main specifications of `FR-5317-C001` and plan power, control and mechanical integration.
...
| --- | --- |
| Input voltage | **7.4 V** |
| Stall torque | **17 kg·cm@7.4V** |
| Control interface | `PWM` |
| Product family | `FR` |
| Product model | `FR5317M` |
