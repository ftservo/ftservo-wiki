...
Use this page to compare the main specifications of `FT-2811-C001` and plan power, control and mechanical integration.
...
| --- | --- |
| Input voltage | **7.4 V** |
| Stall torque | **11 kg·cm@7.4V** |
| Control interface | `PWM` |
| Product family | `FT` |
| Product model | `FT2811M-C001` |
