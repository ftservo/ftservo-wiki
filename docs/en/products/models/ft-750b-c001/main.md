...
Use this page to compare the main specifications of `FT-750B-C001` and plan power, control and mechanical integration.
...
| Stall torque | **750 kg·cm@24V** |
| Control interface | `PWM` |
| Product family | `FT` |
| Product model | `FT750BL` |
