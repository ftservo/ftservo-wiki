...
Use this page to compare the main specifications of `HL-3960-C001` and plan power, control and mechanical integration.
...
| Stall torque | **60 kg·cm@12V** |
| Control interface | `TTL` |
| Product family | `HLS` |
| Product model | `HL-3960-C001` |
