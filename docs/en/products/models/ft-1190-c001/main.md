...
Use this page to compare the main specifications of `FT-1190-C001` and plan power, control and mechanical integration.
...
| --- | --- |
| Input voltage | **6 V** |
| Stall torque | **3.5 kg·cm@6V** |
| Control interface | `PWM` |
| Product family | `FT` |
| Product model | `FT1190M-C001` |
