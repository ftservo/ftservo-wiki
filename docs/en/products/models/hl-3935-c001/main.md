...
Use this page to compare the main specifications of `HL-3935-C001` and plan power, control and mechanical integration.
...
| Item | Value |
| --- | --- |
| Input voltage | **Contact us** |
| Stall torque | **Contact us** |
| Control interface | `TTL` |
| Product family | `HLS` |
| Product model | `HLS3935M-C001` |
