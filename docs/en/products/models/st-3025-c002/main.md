...
Use this page to compare the main specifications of `ST-3025-C002` and plan power, control and mechanical integration.
...
| Stall torque | **40 kg·cm@12V** |
| Control interface | `TTL` |
| Product family | `STS` |
| Product model | `STS3025BL-C002` |
