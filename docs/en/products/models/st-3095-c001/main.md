...
Use this page to compare the main specifications of `ST-3095-C001` and plan power, control and mechanical integration.
...
| --- | --- |
| Input voltage | **7.4 V** |
| Stall torque | **95 kg·cm@7.4V** |
| Control interface | `TTL` |
| Product family | `STS` |
| Product model | `STS3095-C001` |
