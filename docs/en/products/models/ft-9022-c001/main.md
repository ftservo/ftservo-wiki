...
Use this page to compare the main specifications of `FT-9022-C001` and plan power, control and mechanical integration.
...
| --- | --- |
| Input voltage | **7.4 V** |
| Stall torque | **22 kg·cm@7.4V** |
| Control interface | `PWM` |
| Product family | `FT` |
| Product model | `FT9022BL` |
