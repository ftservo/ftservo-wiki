...
Use this page to compare the main specifications of `ST-3120-C001` and plan power, control and mechanical integration.
...
| Stall torque | **120 kg·cm@12V** |
| Control interface | `TTL` |
| Product family | `STS` |
| Product model | `ST-3120-C001` |
