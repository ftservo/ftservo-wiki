...
Use this page to compare the main specifications of `SM-8512-C001` and plan power, control and mechanical integration.
...
| Stall torque | **85 kg·cm@12V** |
| Control interface | `RS-485` |
| Product family | `SMS` |
| Product model | `SM8512BL` |
